...
with tab_telefony:
    ...
    for _c in _calls:
        ...
        # 🟥 Do sekcji kurierów wchodzi rozmowa z POTWIERDZONYM kurierem, nie każda
        #    z ustalonym terminem — inaczej liczba diamentów jest zawyżona.
        _cel = (_kur_by_nr if (_c.get("kurier_ustalony") and _w_k in ("ustalono_termin", "konkret"))
